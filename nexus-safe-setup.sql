...
DECLARE
    offensive_words TEXT[] := ARRAY[
        'palavra1', 'palavra2', 'palavra3', -- Adicionar palavras ofensivas reais aqui
        'xingamento', 'ofensa', 'insulto' -- Exemplos
    ];
    word TEXT;
BEGIN
    ...
    -- Converter para minúsculas e verificar cada palavra
